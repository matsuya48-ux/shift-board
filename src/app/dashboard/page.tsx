  ...
  return (
    <AppShell>
      ...
      >
        ...
        {/* 実働編集ガイド */}
        <p className="mb-5 px-3 text-[13px] leading-relaxed text-[color:var(--ink-3)] animate-rise">
        ...
        {/* 注意書き（ページ最下部） */}
        <p className="mt-8 px-3 text-[13px] leading-relaxed text-[color:var(--ink-3)] animate-rise">
