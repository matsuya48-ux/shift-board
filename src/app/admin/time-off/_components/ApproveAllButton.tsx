  ...
  return (
    <div className="mb-4">
      <button
        ...
        onClick={handle}
        disabled={isPending}
        className="flex h-11 w-full items-center justify-center gap-2 rounded-full bg-[color:var(--accent)] text-[13px] font-medium text-white shadow-[0_6px_18px_-6px_rgba(0,0,0,0.4)] transition-transform active:scale-[0.98] disabled:opacity-50"
      >
        {isPending ? (
